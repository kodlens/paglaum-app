export default () => {
    const features = [
        {
            ...
            desc: "Experience quick and seamless transactions for hassle-free financial management.",
        },
        {
            icon: (
                <svg
            ...
            desc: "Your information is protected with top-tier security measures for peace of mind.",
        },
        {
            icon: (
                <svg
            ...
            title: "Easy Savings Tracking",
            desc: "Effortlessly monitor your savings progress with intuitive, real-time tracking tools.",
        },
    ];
    ...
    return (
        <>
            <section className="relative py-20 bg-gray-900">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 text-gray-300 justify-between gap-24 lg:flex md:px-8">
                    <div className="max-w-xl">
                        ...
                        <p className="mt-3">
                            Experience flexible terms, fast approvals, and
                            personalized service designed to help you succeed.
                        </p>
                    </div>
            ...
            <div className=" bg-gray-900 py-6 px-10 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0 text-white">
                    &copy; 2024 Paglaum Tangub Branch All rights reserved.
                </div>
