    ...
    return (
        <nav
            className={`md:text-sm ${
                state
                    ? "shadow-lg rounded-xl max-w-screen-xl w-full border py-5 md:shadow-none md:border-none md:mx-2 md:mt-0"
                    : ""
            }`}
        >
            <div className=" items-center w-full px-4 md:flex md:px-14">
