                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            ...
                            <a href="https://flowbite.com" className="flex ms-2 md:me-24">
                                ...
                                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">PAGLAUM</span>
                            </a>
                        </div>
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link href="/admin/users" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
