...
const IppLoanIndex = ({ auth }: PageProps)  => {
	...
	const loadDataAsync = async () => {
		...
		try{
			const res = await axios.get<PaginateResponse>(`/ipp/get-loans?${params}`);
