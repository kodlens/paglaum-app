...
const BmSavingsAccountDetailIndex = ({ auth, savingAccount }: PageProps<{savingAccount:SavingsAccount}>) => {
    ...
    const loadDataAsync = async () => {
        ...
        try {
            const res = await axios.get<PaginateResponse>(`/bm/get-savings-account-details?${params}`);
...
export default BmSavingsAccountDetailIndex;
