...
const AdminPendingUserIndex = ({ auth }: PageProps)=> {
	...
	const loadDataAsync = async () => {
		...
		try{
			const res = await axios.get<PaginateResponse>(`/admin/get-pending-users?${params}`);
		...
		<AdminAuthLayout user={auth.user}>
			...
			<div className='flex mt-10 justify-center items-center'>
				...
				<div className='p-6 w-full md:mx-2 bg-white shadow-sm rounded-md
					...
					{/* card header */}
					<div className="font-bold mb-4 text-lg">LIST OF PENDING USERS</div>
					{/* card body */}
					<div className='z-0'>
                        <div>
...
export default AdminPendingUserIndex;
