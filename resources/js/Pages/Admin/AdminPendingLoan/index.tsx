...
import { Captions, FileLock2, MessageSquareMore, ThumbsUp } from 'lucide-react';
...
const AdminPendingLoanIndex = ({ auth }: PageProps) => {
  ...
  const loadDataAsync = async () => {
    ...
    try {
      const res = await axios.get<PaginateResponse>(`/admin/get-pending-loans?${params}`);
    ...
    <AdminAuthLayout user={auth.user}>
      ...
      <div className='flex mt-10 justify-center items-center'>
        ...
        <div className='p-6 w-full md:mx-2 bg-white shadow-sm rounded-md
          ...
          {/* card header */}
          <div className="font-bold mb-4 text-lg">LIST OF PENDING</div>
          {/* card body */}
          <div className='z-0'>
                        ...
                        items: [
                          {
                            ...
                            onClick: () => {
                              router.visit('/admin/member-loan-details/' + data.id)
                            }
                          },
                        ],
                      }}
...
export default AdminPendingLoanIndex;