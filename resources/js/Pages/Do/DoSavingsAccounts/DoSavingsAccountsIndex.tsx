...
import { BookUp, Captions, ClipboardList, FileLock2, MessageSquareMore, Pencil, RefreshCcwIcon, ShieldCheck, ShieldOff, ThumbsDown, ThumbsUp, Trash2, Wallet } from 'lucide-react';
                      ...
                      menu={{
                        items: [
                          ...
                          },
                          {
                            ...
                            onClick: () => router.visit('/do/savings-account-details/' + data.id)
                          },
                        ],
                      }}
                      trigger={['click']}
