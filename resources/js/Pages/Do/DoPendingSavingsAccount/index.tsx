...
import { Captions, CheckCheck, FileLock2, MonitorCheck, Pencil, Pocket, ShieldOff, ThumbsDown, ThumbsUp, Trash2 } from 'lucide-react';
...
const DoPendingSavingsAccountIndex = ({ auth }: PageProps) => {
    ...
    const loadDataAsync = async () => {
        ...
        try {
            const res = await axios.get<PaginateResponse>(`/do/get-pending-savings-account?${params}`);
                                    ...
                                    <Dropdown.Button type="primary"
                                        ...
                                        menu={{
                                            items: [
                                                {
                                                    key: '2',
                                                    label: data.is_do_approved ? 'DO Disapprove' : 'DO Approve',
...
export default DoPendingSavingsAccountIndex;
